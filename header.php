...
<body <?php body_class(); ?>>
	...
	<header role="banner" class="navbar navbar-static-top bs-docs-nav top-header-navbar">
                                    ...
                                    <ul class="dropdown-menu open-drop-menu">
                                        <li class="drop-section">
                                            <div class="drop-left-block">
                                                <h4>Resources</h4>
                                                <ul>
                                                    <li><i class="fa fa-pencil"></i><a href="http://local.kenneth.com/?page_id=63 ">Contact</a></li>
	        ...
	        <section class="video-container bg-video-img">
	            <video width="300" height="150" autoplay="autoplay" loop="loop" poster="/wp-content/themes/wptest3/images/video.jpg">
	                <source src="/wp-content/themes/wptest3/video/preview.mp4" type="video/mp4">
	                <source src="/wp-content/themes/wptest3/video/preview.flv" type="video/flv">
	                <source src="/wp-content/themes/wptest3/video/preview.webm" type="video/webm">
	                <source src="/wp-content/themes/wptest3/video/preview.ogg" type="video/webm">
	            </video>
	            <div class="row">
	                <div class="container">
	                    <div class="col-sm-12 col-md-12">
	                        <h1><span class="font-light">Your Best Source for</span> Software Development</h1>
	                        <p class="we-know">We know timelines and budgets are not suggestions</p>
	                        <a href="#" class="watch-video" id="modalVideoStart">
	                            <span class="icon-watch"></span>
	                            Watch the video
	                        </a>
	                        <a href="http://local.kenneth.com/#contact-form" id="cooneus" class="talk-btn talkoneus">Let's Talk Business!</a>
	                        <a href="" class="down lik-to-bot" style="-webkit-transition: 0s; -moz-transition: 0s; -ms-transition: 0s; -o-transition: 0s; transition: 0s;bottom:12px;opacity: 0.30000000000000004!important"><span class="fa fa-angle-down"></span></a>
	                    </div>
	                </div>
	            </div>
	        </section>
	        <header role="banner" class="navbar navbar-static-top bs-docs-nav top-header-navbar fix-two-menu" 		style="margin-top: 30px;">
	            <div class="container-fluid" style="padding: 0;">
	                <nav role="navigation" class="navbar navbar-default">
	                    <div class="navbar-header">
	                        <div class="logo">
